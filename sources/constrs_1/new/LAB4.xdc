...
set_property PACKAGE_PIN W5 [get_ports clk]							
 ...
 ## is buzzer functioning or is it supposed to be the other case?
...
#set_property PACKAGE_PIN T3 [get_ports {selector}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {selector}]
set_property PACKAGE_PIN T2 [get_ports {reset_highscore}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {reset_highscore}]
set_property PACKAGE_PIN R3 [get_ports {set_highscore}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {set_highscore}]
set_property PACKAGE_PIN W2 [get_ports {score_display}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {score_display}]
...
##Buttons
#set_property PACKAGE_PIN U18 [get_ports min_up]						
	#set_property IOSTANDARD LVCMOS33 [get_ports min_up]
...
#set_property PACKAGE_PIN K3 [get_ports {JXADC[4]}]				
	#set_property IOSTANDARD LVCMOS3
